...
import fr.isep.dictionary.databinding.DescriptionsOfTheWordBinding
import fr.isep.dictionary.models.Meaning


class MeaningAdapter(private var meaningList : List<Meaning>) : RecyclerView.Adapter<MeaningAdapter.MeaningViewHolder>()  {

    class MeaningViewHolder( private  val binding: DescriptionsOfTheWordBinding) : RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MeaningViewHolder {
        val binding = DescriptionsOfTheWordBinding.inflate(LayoutInflater.from(parent.context),parent,false)
